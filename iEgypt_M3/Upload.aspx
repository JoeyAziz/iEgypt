<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upload.aspx.cs" Inherits="WA1.Upload" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="text-align:center;">
            <div class="StyleTitle">Upload Original Content</div><br /><br />
            <br /><br /><br /><hr /><br /><br />
             <input runat="server" type="text" id="inputCategoryName" placeholder="Category Name **" />
             ...
             <asp:Button ID="uploadButton" class="StyleButton" runat="server" Text="UPLOAD" OnClick="UploadOriginalContent"/><br/>
